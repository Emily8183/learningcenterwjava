...
export class CdkInfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Stage "prod" is automatically generated by CDK
    const leetcomparerestapi = new apigateway.RestApi(this, "LeetCompareApi", {
      ...
      defaultCorsPreflightOptions: {
        ...
        allowOrigins: ["https://emily.brajk.me"],
    ...
    //usagePlan: to define the plan for this API usage, incl api, rate limit, and stage
    const usagePlan = leetcomparerestapi.addUsagePlan("LeetCompareUsagePlan", {
      name: "EmilyLeetCompUsagePlan",
      apiStages: [
        {
          api: leetcomparerestapi,
          stage: leetcomparerestapi.deploymentStage, //tie with prod
        },
      ],
    });
